...
export default function Footer(){
  return (
    <footer className="bg-gray-100 text-gray-700 mt-12">
      <div className="container py-8 sm:py-10 px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
        <div>
        ...
        <div>
          ...
          <ul className="text-xs sm:text-sm space-y-1">
            ...
            <li><Link to="/partner" className="hover:text-red-700 transition-colors">Partner</Link></li>
        ...
        <div>
          <h4 className="font-bold text-base sm:text-lg mb-2">{SITE.orgName}</h4>
          <p className="text-xs sm:text-sm mb-4">Address: {SITE.address}</p>
