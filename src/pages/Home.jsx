        ...
        <div className="relative w-full min-h-[70vh] flex items-center justify-center text-white overflow-hidden">
          ...
          <div className="relative z-20 w-full text-center space-y-4 px-4 max-w-5xl mx-auto">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-tight mb-4">
              Be The <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-orange-400 animate-shimmer drop-shadow-lg">Future</span>. <br />
