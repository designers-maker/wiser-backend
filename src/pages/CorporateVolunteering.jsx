      ...
      <section className="relative pt-20 pb-16 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-6xl font-bold tracking-tight text-slate-900">
            Corporate <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-orange-600">Volunteering</span>
          </h1>
          
          <p className="text-lg sm:text-2xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
            Join us as a corporate partner and help create real impact in community.
          </p>

          {/* Buttons Section */}
          <div className="flex flex-wrap items-center justify-center gap-4">
            
            {/* CSR Partnership Button */}
            <button
        ...
        <div className="grid md:grid-cols-2 gap-10 items-stretch">
          ...
          <div className="bg-white p-8 md:p-5 rounded-3xl shadow-xl border border-slate-100 hover:shadow-2xl transition-all duration-300 h-full flex flex-col">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-slate-900">Why Corporate Volunteering?</h3>
            </div>
