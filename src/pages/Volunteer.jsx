...
export default function Volunteer() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans selection:bg-red-500 selection:text-white">
      ...
      <section className="relative pt-20 pb-16 px-4 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-8">
          ...
          <button
            ...
            className="group inline-flex items-center justify-center px-10 py-4 font-bold text-white text-lg rounded-full shadow-2xl overflow-hidden transition-all duration-300 hover:scale-110 hover:shadow-red-500/40"
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-7 md:p-10 rounded-3xl shadow-2xl text-white relative overflow-hidden h-full flex flex-col">
            ...
            <div className="space-y-6 flex-grow">
              <div className="relative pl-8 border-l-2 border-slate-600 pb-6 last:pb-0 last:border-0">
                ...
                <p className="text-slate-300 text-sm md:text-base">Fill out the volunteer form with your details, interests, and availability.</p>
              </div>
      ...
      {/* 3. Quote Section - Attractive Typography */}
      <section className="w-full py-0 bg-blue">
        <div className="max-w-5xl mx-auto px-2 text-center">
          <div className="text-6xl text-red-500 opacity-20 font-serif leading-none mb-4"></div>
          <p className="text-2xl md:text-4xl font-bold text-slate-900 leading-tight mb-8 max-w-4xl mx-auto">
            The best way to find yourself is to lose yourself in the service of others.
          </p>
          <div className="w-24 h-1 bg-orange-600 mx-auto mb-4 rounded-full"></div>
          <p className="text-lg font-semibold text-slate-500 tracking-wide uppercase">Mahatma Gandhi</p>
        </div>
      </section>

      {/* 4. Footer CTA */}
      <section className="w-full bg-slate-900 py-2 text-white text-center relative overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-800 via-slate-900 to-slate-900 opacity-80"></div>
        <div className="relative z-10 max-w-5xl mx-auto px-4 space-y-4">
          ...
          <p className="text-lg md:text-xl text-slate-300 max-w-2xl mx-auto">
            Join thousands of volunteers creating change every day.
          </p>
          <button 
            onClick={() => navigate('/volunteer/form')}
            className="px-12 py-4 bg-orange-600 hover:bg-blue-700 text-white font-bold text-lg rounded-full shadow-2xl hover:shadow-red-900/50 hover:scale-105 transition-all duration-300"
          >
            Apply Now
          </button>
        </div>
