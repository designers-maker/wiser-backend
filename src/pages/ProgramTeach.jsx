...
// Animate Circle Stroke dynamically based on the current rate
...
<h2 className="text-3xl md:text-5xl font-bold donation-gradient">About the Program</h2>
...
<h3 className="text-3xl md:text-5xl font-bold donation-gradient mt-2">Program in Action</h3>
</div>
...
{/* CHANGE 2: How to Get Involved - Changed to text-white */}
